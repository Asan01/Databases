...
SELECT * FROM employees WHERE department = 34 OR department = 77;
...
SELECT name FROM departments ORDER BY budget LIMIT 1 OFFSET 1;
...
SELECT name FROM departments WHERE budget > 60000
